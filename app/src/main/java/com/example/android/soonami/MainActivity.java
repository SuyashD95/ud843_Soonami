...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            // If the URL passed is null, then, return an empty string
            if(url == null) {
                return jsonResponse;
            }
            ...
            try {
                ...
                // If the response code is 200 (Success), then continue parsing JSON,
                // otherwise, do not attempt parsing the JSON
